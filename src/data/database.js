export default {
  ...
  description: [
    ...
    [
      ...
      'Hangares.',
      'Garagem sem acesso de público, com abastecimento.',
    ],
    [
  ...
  details: [
    ...
    [
      ...
      ['Restaurantes'],
      ['jardins zoológicos, parques recreativos'],
      ['Exposições'],
      ['Auditórios em geral, com palcos sem movimentação de cenários.'],
    ],
    [
      ['Estacionamentos'],
      ['Estacionamentos'],
  ...
  charge: [
    ...
    ['Baixa - Menor que 300', 'Media - de 300 a 1200', 'Alta - Meior que 1200'],
  ],
